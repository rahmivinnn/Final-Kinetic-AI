                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {security.twoFactorAuth
                        ? "Enabled - Requires authentication code when signing in"
                        : "Disabled - No additional security"}
                    </p>
                  </div>
                  <Switch
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  ...
                  <div className="rounded-lg border p-4">
                    <h3 className="mb-2 font-medium">Billing History</h3>
