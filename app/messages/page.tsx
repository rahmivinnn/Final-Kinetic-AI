...
export default function MessagesPage() {
  ...
  const { data: conversations, loading, error, refetch } = useMessages(user?.id)
  ...
  const handleSendMessage = async () => {
    ...
    try {
      await sendMessage({
        ...
        content: newMessage,
        senderId: user?.id,
        receiverId: selectedConversation.participants.find((p: any) => p.id !== user?.id)?.id
      })
            ...
            <div className="space-y-3">
              {recentConversations.map((conversation) => (
                <div
                  ...
                  className={`bg-white rounded-lg shadow-sm p-4 flex items-center justify-between hover:bg-gray-50 cursor-pointer transition-colors ${
                    selectedConversation?.id === conversation.id ? 'ring-2 ring-[#014585]' : ''
                  }`}
                >
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button 
                    ...
                    onClick={() => {
                      ...
                      window.location.href = `/messages/${selectedConversation.id}/video`;
                    }}
                  >
                        ...
                        <div
                          className={`max-w-xs lg:max-w-md px-4 py-2 rounded-lg ${
                            message.senderId === user?.id
                              ? 'bg-[#014585] text-white rounded-br-none'
              ...
              <div className="border-t border-gray-200 p-4">
                <div className="max-w-3xl mx-auto flex items-center">
                  ...
                  <button
                    ...
                    className="ml-2 p-2 rounded-full bg-[#014585] text-white disabled:opacity-50"
                  >
